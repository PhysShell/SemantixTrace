...
/// </para>
/// <para>
/// <c>CanExecuteChanged</c> delegates to the inner command's event so that
/// Avalonia command-manager invalidation propagates correctly.
/// </para>
/// </remarks>
...
public sealed class TracedRelayCommand : ICommand
{
    ...
    /// Avalonia command invalidation propagates correctly.
    /// </remarks>
